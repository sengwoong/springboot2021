...
context.setStrategy(AppeendStrategy);
const encodMessage = context.encodeMessage(message);


console.log("Base64 Encoded Message:", encodedMessage);
console.log("AppeendStrategy Encoded Message:", encodMessage);